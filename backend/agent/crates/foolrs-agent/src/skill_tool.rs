...
use foolrs_skills::context_modifier::ContextModifier;
use foolrs_skills::executor::{execute_fork, prepare_inline_content};
use foolrs_skills::hooks::{parse_skill_hooks, to_hook_defs};
use foolrs_skills::permissions::{SkillPermission, SkillPermissionChecker};
use foolrs_skills::types::{ExecutionContext, SkillMetadata};
...
pub struct SkillTool {
    ...
    /// Session ID passed to prepare_inline_content for ${FOOLRS_SESSION_ID} substitution.
...
impl Tool for SkillTool {
    ...
    fn context_modifier_for(&self, input: &serde_json::Value) -> Option<ContextModifier> {
        ...
        foolrs_skills::context_modifier::from_skill(skill)
    }
