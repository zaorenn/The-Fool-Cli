...
mod tests {
    ...
    use foolrs_skills::types::{ExecutionContext, LoadedFrom, SkillSource};
    use serde_json::json;
...
mod supplemental_tests {
    ...
    use foolrs_skills::permissions::SkillPermissionChecker;
    use foolrs_skills::types::{ExecutionContext, LoadedFrom, SkillMetadata, SkillSource};
    ...
    async fn tc_13_8_full_variable_substitution_integration() {
        let mut skill = make_skill("my-skill", "Run ${FOOLRS_SKILL_DIR}/tool.sh $ARGUMENTS[0]");
...
mod supplemental_tests_p6 {
    ...
    use foolrs_skills::permissions::SkillPermissionChecker;
    use foolrs_skills::types::{EffortLevel, ExecutionContext, LoadedFrom, SkillMetadata, SkillSource};
    use foolrs_tools::Tool;
