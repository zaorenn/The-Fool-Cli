use foolrs_config::compat::{self, ProviderCompat, ToolWireShape};
use foolrs_config::schema::legalize_json_schema;
use foolrs_types::llm::{LlmRequest, ThinkingConfig};
use foolrs_types::tool::{ToolDef, truncate_deferred_description};
