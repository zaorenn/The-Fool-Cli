...
use fool_api_types::{TeamAgentResponse, TeamResponse};
...
mod tests {
    ...
    #[test]
    fn teammate_status_parse_fool_aliases() {
    ...
    #[test]
    fn teammate_status_serde_fool_aliases() {
    ...
    #[test]
    fn team_agent_deserialize_fool_format() {
