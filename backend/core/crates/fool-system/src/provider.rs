...
use fool_api_types::{CreateProviderRequest, ProviderResponse, UpdateProviderRequest};
use fool_common::{decrypt_string, encrypt_string};
use fool_db::{CreateProviderParams, IProviderRepository, UpdateProviderParams, models::Provider};
...
mod tests {
    ...
    use fool_db::{SqliteProviderRepository, init_database_memory};
    ...
    fn validate_create_bedrock_allows_empty_base_url_and_api_key() {
        let req = CreateProviderRequest {
            ...
            base_url: "".into(),
            api_key: "".into(),
            bedrock_config: Some(fool_api_types::BedrockConfig {
                auth_method: fool_api_types::BedrockAuthMethod::Profile,
