...
use fool_api_types::{OAuthLoginResponse, OAuthStatusResponse};
use fool_common::{TimestampMs, now_ms};
use fool_db::{IOAuthTokenRepository, UpsertOAuthTokenParams};
...
const DEFAULT_CLIENT_ID: &str = "fool";
...
impl McpOAuthService {
    ...
    pub async fn logout(&self, user_id: &str, server_url: &str) -> Result<(), McpError> {
        match self.token_repo.delete(user_id, server_url).await {
            ...
            Err(fool_db::DbError::NotFound(_)) => {
    ...
    async fn handle_callback_connection(
        ...
        let response = "HTTP/1.1 200 OK\r\n\
            ...
            <p>You can close this window and return to The Fool.</p>\
            </body></html>";
...
mod tests {
    ...
    impl IOAuthTokenRepository for MockTokenRepo {
        async fn get_by_url(
            ...
            _: &str,
            _: &str,
        ) -> Result<Option<fool_db::models::OAuthTokenRow>, fool_db::DbError> {
            Ok(None)
        }
        ...
        ) -> Result<fool_db::models::OAuthTokenRow, fool_db::DbError> {
            unimplemented!()
        }

        async fn delete(&self, _: &str, _: &str) -> Result<(), fool_db::DbError> {
            Ok(())
        }
    ...
    impl IOAuthTokenRepository for ValidTokenRepo {
        async fn get_by_url(
            ...
            Ok(Some(fool_db::models::OAuthTokenRow {
