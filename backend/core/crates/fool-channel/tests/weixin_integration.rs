...
mod weixin_tests {
    ...
    use fool_channel::plugin::ChannelPlugin;
    use fool_channel::plugins::weixin::WeixinPlugin;
    use fool_channel::types::{PluginConfig, PluginCredentials, PluginStatus, PluginType};
    ...
    fn login_event_qr_serializes_correctly() {
        use fool_channel::plugins::weixin::weixin_login_stream;
