...
impl AssistantService {
    ...
    ///    Bedrock, Vertex, …), return `"foolrs"`. AionRS speaks both
...
mod tests {
    ...
    async fn foolrs_assistant_resolves_agent_status_via_agent_type_not_backend() {
        ...
        foolrs_row.agent_type = aionui_common::AgentType::Aionrs;

        let mut builtin = mk_builtin("builtin-foolrs", "Aion Assistant");
