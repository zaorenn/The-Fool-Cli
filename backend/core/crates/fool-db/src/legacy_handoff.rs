...
mod tests {
    ...
    fn migration_002_direct_legacy_reads_are_audited() {
        ...
        let documented_non_contract_reads = [
            ("messages", "hidden", "The Fool v22 adds it before v23-v26 issue path"),
            (
                "conversations",
                "source",
                "The Fool v8 baseline before v23-v26 issue path",
            ),
            (
                "conversations",
                "channel_chat_id",
                "The Fool v14 baseline before v23-v26 issue path",
            ),
            ("mailbox", "files", "The Fool v25 adds it on the observed v23->v26 path"),
            (
                "remote_agents",
                "allow_insecure",
                "The Fool v18 baseline before v23-v26 issue path",
            ),
            (
                "cron_jobs",
                "execution_mode",
                "The Fool v22 baseline before v23-v26 issue path",
            ),
            (
                "cron_jobs",
                "agent_config",
