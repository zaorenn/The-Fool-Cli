...
mod tests {
    ...
    #[test]
    fn test_reserved_prefix_fool() {
        let manifest = ExtensionManifest {
            name: "fool-my-ext".into(),
            version: "1.0.0".into(),
            display_name: None,
            description: None,
            author: None,
        ...
        assert!(matches!(
            err,
            ExtensionError::ReservedNamePrefix { ref prefix, .. } if prefix == "fool-"
        ));
    }
    ...
    #[test]
    fn test_parse_manifest_in_dir_supports_fool_main_contract() {
