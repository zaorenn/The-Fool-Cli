...
///
/// Data is stored in `~/.fool/custom-skill-paths.json`.
...
impl ExternalPathsManager {
    ...
    /// Enable the fool skills market by adding it to external paths.
    ...
    /// Disable the fool skills market by removing it from external paths.
