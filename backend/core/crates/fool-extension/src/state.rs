...
const EXTENSION_STATES_FILE_ENV: &str = "FOOL_EXTENSION_STATES_FILE";
...
/// Resolve the extension state file path using the historical The Fool rules.
///
/// Priority:
/// 1. `FOOL_EXTENSION_STATES_FILE`
