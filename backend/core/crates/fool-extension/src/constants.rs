...
pub const EXTENSION_MANIFEST_FILE: &str = "fool-extension.json";
...
pub const RESERVED_NAME_PREFIXES: &[&str] = &["fool-", "internal-", "builtin-", "system-"];
...
/// Well-known skill source name for the fool skills market.
pub const SKILLS_MARKET_NAME: &str = "fool-skills";

/// Well-known skill source path for the fool skills market.
///
...
pub const SKILLS_MARKET_PATH: &str = "https://github.com/The Fool/fool-skills";
...
mod tests {
    ...
    fn test_manifest_file_name() {
        assert_eq!(EXTENSION_MANIFEST_FILE, "fool-extension.json");
    }

    #[test]
    fn test_reserved_prefixes_contains_expected() {
        assert!(RESERVED_NAME_PREFIXES.contains(&"fool-"));
