...
mod tests {
    ...
    fn linux_show_item_uses_filemanager1_when_gdbus_available() {
        let path = Path::new("/home/user/Downloads/The Fool.deb");
        ...
        assert!(args.contains(&"['file:///home/user/Downloads/The Fool.deb']".to_owned()));
    ...
    fn linux_show_item_percent_encodes_spaces_in_uri() {
        ...
        assert_eq!(program, "gdbus");
        assert!(
            args.contains(&"['file:///home/user/My%20Downloads/The Fool.deb']".to_owned()),
