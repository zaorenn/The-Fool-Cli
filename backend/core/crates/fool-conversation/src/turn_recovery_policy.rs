...
use fool_common::{AgentKillReason, AgentType};
use tracing::info;
...
#[cfg(test)]
mod tests {
    use fool_api_types::{AgentErrorCode, AgentErrorOwnership, AgentStreamErrorData};
    use fool_common::{AgentKillReason, AgentType};
    ...
    fn non_acp_agent_does_not_auto_replay() {
        ...
        let decision =
            TurnRecoveryPolicy::decide(AgentType::Foolrs, None, &outcome, RuntimeLifecycleState::Active, false);
