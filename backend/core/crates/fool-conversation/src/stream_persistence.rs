...
use fool_db::{ConversationRowUpdate, DbError, IConversationRepository, MessageRowUpdate};
...
impl StreamPersistenceAdapter {
    ...
    #[tracing::instrument(skip_all)]
    pub async fn persist_tool_call(&self, data: &fool_ai_agent::protocol::events::tool_call::ToolCallEventData) {
    ...
    #[tracing::instrument(skip_all)]
    pub async fn persist_tool_group(&self, entries: &[fool_ai_agent::protocol::events::tool_call::ToolGroupEntry]) {
