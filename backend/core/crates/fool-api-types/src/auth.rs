...
// ---------------------------------------------------------------------------
// Internal Pro user provisioning endpoints
// ---------------------------------------------------------------------------
...
/// Stable internal auth error codes for Pro/Core session exchange.
#[derive(Debug, Clone, Copy, Serialize, Deserialize, PartialEq, Eq)]
