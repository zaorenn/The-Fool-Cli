...
use fool_api_types::SlashCommandItem;
...
impl AcpAgentManager {
    ...
    async fn emit_snapshot_events(&self) {
        use fool_api_types::{ModelInfoEntry, ModelInfoPayload};
...
mod tests {
    ...
    use fool_api_types::{AgentErrorCode, SlashCommandCompletionBehavior, SlashCommandItem};
