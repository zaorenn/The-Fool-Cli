...
const ACP_CLIENT_NAME: &str = "The Fool";
...
/// Log a JSON-RPC request from The Fool to the ACP agent.
...
/// Log a fire-and-forget notification from The Fool to the agent.
...
/// Log a JSON-RPC response from The Fool back to the agent.
...
mod tests {
    ...
    fn initialize_request_sends_non_empty_client_info() {
        ...
        assert_eq!(client_info.name, "The Fool");
        ...
        assert_eq!(json["clientInfo"]["name"], "The Fool");
