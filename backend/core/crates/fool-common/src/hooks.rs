...
//!
//! Hooks defined here let lower-layer crates (e.g. `fool-ai-agent`,
//! `fool-cron`) react to events owned by higher-layer crates (e.g.
//! `fool-conversation`) without forming a dependency cycle.
