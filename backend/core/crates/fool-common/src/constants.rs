...
pub const FOOL_TIMESTAMP_SEPARATOR: &str = "_fool_";
pub const FOOL_FILES_MARKER: &str = "[[FOOL_FILES]]";
...
pub const COOKIE_NAME: &str = "fool-session";
pub const COOKIE_MAX_AGE_DAYS: u32 = 30;
pub const CSRF_COOKIE_NAME: &str = "fool-csrf-token";
