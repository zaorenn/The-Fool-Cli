//! Agent-readable capability contract for `foolcore diagnose`.

use serde_json::{Value, json};

const RUNTIME_ENV: [&str; 3] = ["FOOL_BASE_URL", "FOOL_CONVERSATION_ID", "FOOL_USER_ID"];
...
pub(crate) fn data() -> Value {
    json!({
        ...
        "runtime_context": {
            ...
            "optional_environment": ["FOOL_LOG_DIR"]
        },
        "safety": {
            "read_only": true,
            "redacted_by_default": [
        ...
        "domains": [
            ...
            domain("logs", &[
                command(CommandDescriptor {
                    path: &["logs", "tail"],
                    description: "Tail foolcore logs from FOOL_LOG_DIR or stdin log_dir.",
                    input: "stdin_json",
