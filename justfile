...
preflight:
    ...
    $failed = $false
    Write-Host "=========================================="
    Write-Host "  The Fool Build Preflight Check"
    Write-Host "=========================================="
    Write-Host ""
...
info:
    #!/usr/bin/env bash
    echo "The Fool Build Environment"
    echo "========================"
...
build-win: preflight
    ...
    Get-Process -Name "The Fool","electron" -ErrorAction SilentlyContinue | Stop-Process -Force -ErrorAction SilentlyContinue
