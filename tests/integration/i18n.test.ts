...
describe('i18n Configuration Tests', () => {
  it('index.ts should exist', () => {
    const indexFile = path.resolve(__dirname, '../../packages/desktop/src/renderer/services/i18n/index.ts');
    expect(fs.existsSync(indexFile)).toBe(true);
  });
...
describe('i18n Build Safety Tests', () => {
  const mainI18nFile = path.resolve(__dirname, '../../packages/desktop/src/process/services/i18n/index.ts');
  const rendererI18nFile = path.resolve(__dirname, '../../packages/desktop/src/renderer/services/i18n/index.ts');
  ...
  it('hardcoded English strings should not exist in TSX component files', () => {
    ...
    const filesToCheck = [
      path.resolve(__dirname, '../../packages/desktop/src/renderer/components/SettingsModal/contents/ModelModalContent.tsx'),
      path.resolve(__dirname, '../../packages/desktop/src/renderer/pages/conversation/Preview/components/viewers/URLViewer.tsx'),
      path.resolve(__dirname, '../../packages/desktop/src/renderer/pages/conversation/Workspace/index.tsx'),
    ];
