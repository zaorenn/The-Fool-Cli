...
describe('deepLink module', () => {
  ...
  describe('parseDeepLinkUrl', () => {
    it('should parse simple deep link URL', async () => {
      const { parseDeepLinkUrl } = await import('@/process/deepLink');
  ...
  describe('handleDeepLinkUrl', () => {
    it('should queue URL when no window is set', async () => {
      const { handleDeepLinkUrl, getPendingDeepLinkUrl } = await import('@/process/deepLink');
    ...
    it('should emit via ipcBridge when window is available', async () => {
      ...
      const { handleDeepLinkUrl, setDeepLinkMainWindow } = await import('@/process/deepLink');
