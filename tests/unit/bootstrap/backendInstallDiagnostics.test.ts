...
describe('collectBackendInstallDiagnostics', () => {
  it('records packaged runtime manifest and missing backend binary metadata', () => {
    const files = new Map<string, { mtimeMs: number; size: number; content?: string }>([
      ['C:\\TheFool\\resources', { mtimeMs: 1000, size: 0 }],
      ['C:\\TheFool\\resources\\bundled-foolcore\\win32-x64', { mtimeMs: 2000, size: 0 }],
      [
        'C:\\TheFool\\resources\\bundled-foolcore\\win32-x64\\manifest.json',
        {
          mtimeMs: 3000,
          size: 88,
    ...
    const diagnostics = collectBackendInstallDiagnostics(
      {
        ...
        resourcesPath: 'C:\\TheFool\\resources',
        checkedBundledPath: 'C:\\TheFool\\resources\\bundled-foolcore\\win32-x64\\foolcore.exe',
      },
      {
        appVersion: '2.1.7',
        arch: 'x64',
        execPath: 'C:\\TheFool\\The Fool.exe',
        isPackaged: true,
        platform: 'win32',
    ...
    expect(diagnostics).toEqual({
      ...
      binaryExists: false,
      binaryName: 'foolcore.exe',
      binaryPath: 'C:\\TheFool\\resources\\bundled-foolcore\\win32-x64\\foolcore.exe',
      bundledDirPath: 'C:\\TheFool\\resources\\bundled-foolcore',
      execPath: 'C:\\TheFool\\The Fool.exe',
      isPackaged: true,
      manifestExists: true,
      manifestFiles: ['foolcore.exe', 'managed-resources/'],
      manifestGeneratedAt: '2026-05-29T12:00:00.000Z',
      manifestPath: 'C:\\TheFool\\resources\\bundled-foolcore\\win32-x64\\manifest.json',
      manifestSize: 88,
      ...
      runtimeDirPath: 'C:\\TheFool\\resources\\bundled-foolcore\\win32-x64',
      runtimeKey: 'win32-x64',
    });
  });
});
