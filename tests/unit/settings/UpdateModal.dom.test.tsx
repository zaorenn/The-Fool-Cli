...
describe('UpdateModal manual install fallback', () => {
  ...
  it('keeps fast manual download completion matched to the caller-provided download id', async () => {
    ...
    act(() => {
      window.dispatchEvent(new Event('fool-open-update-modal'));
    });
    ...
    expect(mocks.updateDownloadMock).toHaveBeenCalledWith({
      ...
      url: 'https://github.com/zaorenn/The-Fool-Cli/releases/download/v2.1.14/TheFool-2.1.14-mac-arm64.dmg',
      fallbackUrl: 'https://github.com/zaorenn/The-Fool-Cli/releases/download/v2.1.14/TheFool-2.1.14-mac-arm64.dmg',
      file_name: 'The Fool-2.1.14-mac-arm64.dmg',
    });
