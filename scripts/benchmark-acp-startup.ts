...
function getLogFilePath(): string {
  ...
  // Dev mode uses "The Fool-Dev", production uses "The Fool"
  const devPath = path.join(os.homedir(), 'Library', 'Logs', 'The Fool-Dev', `${today}.log`);
  const prodPath = path.join(os.homedir(), 'Library', 'Logs', 'The Fool', `${today}.log`);
