  ...
  return (
    ...
    >
      <Form form={form}>
        ...
        <Form.Item label={t('settings.apiKey')} required rules={[{ required: true }]} field={'apiKey'} extra={<div style={{ fontSize: '11px', color: 'var(--text-secondary)', marginTop: '4px' }}>💡 {t('settings.multiApiKeyEditTip')}</div>}>
