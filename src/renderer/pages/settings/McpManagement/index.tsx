...
const McpManagement: React.FC<McpManagementProps> = ({ message }) => {
  ...
  const { agentInstallStatus, setAgentInstallStatus, isServerLoading, checkAgentInstallStatus, checkSingleServerInstallStatus } = useMcpAgentStatus();
