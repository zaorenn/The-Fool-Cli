      ...
      >
        <div className={classNames('flex w-full flex-col', isMobile ? 'gap-6px' : 'gap-8px')}>
          <div className='flex w-full items-start justify-between gap-12px sm:gap-16px max-[520px]:flex-wrap'>
            <h1
              className={classNames(
                'm-0 min-w-0 flex-1 font-bold text-text-1 dark:text-t-primary',
          ...
          <p
            className={classNames(
              'm-0 w-full text-text-3 dark:text-t-secondary',
        ...
        <div className='grid w-full box-border grid-cols-[minmax(0,1fr)_auto] items-center gap-x-12px gap-y-10px rounded-12px border border-solid border-[var(--color-border-2)] bg-fill-2 px-14px py-12px sm:rounded-14px sm:px-16px max-[520px]:grid-cols-1'>
          <span
            className={classNames(
              'min-w-0 text-text-2 dark:text-t-primary',
          ...
          <div className='justify-self-end max-[520px]:justify-self-start'>
            <Tooltip content={t('cron.page.keepAwakeTooltip')}>
              <div className='flex items-center gap-8px text-text-3 dark:text-t-secondary text-12px leading-18px sm:text-13px'>
              ...
              return (
                ...
                >
                  <div className='mb-12px flex items-center justify-between gap-8px'>
                    <span
                      className={classNames(
                        'mr-8px min-w-0 flex-1 font-medium text-text-1 dark:text-t-primary',
                  ...
                  <div
                    className={classNames(
                      'min-w-0 break-words text-text-2 dark:text-t-secondary',
                      isMobile ? 'text-13px leading-20px' : 'text-14px leading-22px'
                    )}
                  ...
                  <div
                    className='mt-16px min-w-0 break-words text-text-2 dark:text-t-secondary text-13px leading-20px'
                  ...
                  <div className='mt-14px flex items-center justify-between gap-10px'>
                    <div className='min-w-0 flex items-center gap-6px text-12px leading-18px text-text-3 dark:text-t-secondary'>
                      {agentMeta.name ? (
                        <Tooltip content={agentMeta.name}>
                          <div className='flex h-16px w-16px shrink-0 items-center justify-center text-text-3 dark:text-t-secondary'>
                            {agentMeta.logo ? (
                              <img
                                src={agentMeta.logo}
                                alt={agentMeta.name}
                              ...
                              <span className='flex h-16px w-16px items-center justify-center rounded-50% text-10px font-medium text-text-3 dark:text-t-secondary'>
