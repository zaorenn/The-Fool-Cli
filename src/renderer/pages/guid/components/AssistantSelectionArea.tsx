      ...
      <div className='flex flex-wrap gap-8px justify-center'>
        {customAgents
          ...
          .map((assistant) => {
            ...
            return (
              <div key={assistant.id} className='h-28px group flex items-center gap-8px px-16px rd-100px cursor-pointer transition-all b-1 b-solid bg-fill-0 hover:bg-fill-1 select-none' style={{ borderWidth: '1px', borderColor: 'color-mix(in srgb, var(--color-border-2) 70%, transparent)' }} onClick={() => onSelectAssistant(`custom:${assistant.id}`)}>
