...
interface EventTypes {
  ...
  'openclaw.selected.file': [Array<string | FileOrFolderItem>];
  'openclaw.selected.file.append': [Array<string | FileOrFolderItem>];
  'openclaw.selected.file.clear': void;
  'openclaw.workspace.refresh': void;
