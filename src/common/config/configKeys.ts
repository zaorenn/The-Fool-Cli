...
export type ConfigKeyMap = {
  ...
  'assistant.telegram.agent': { agent_type: string; backend?: string; custom_agent_id?: string; name?: string } | undefined;
  'assistant.lark.defaultModel': { id: string; use_model: string } | undefined;
  'assistant.lark.agent': { agent_type: string; backend?: string; custom_agent_id?: string; name?: string } | undefined;
  'assistant.dingtalk.defaultModel': { id: string; use_model: string } | undefined;
  'assistant.dingtalk.agent': { agent_type: string; backend?: string; custom_agent_id?: string; name?: string } | undefined;
  'assistant.weixin.defaultModel': { id: string; use_model: string } | undefined;
  'assistant.weixin.agent': { agent_type: string; backend?: string; custom_agent_id?: string; name?: string } | undefined;
  'assistant.wecom.defaultModel': { id: string; use_model: string } | undefined;
  'assistant.wecom.agent': { agent_type: string; backend?: string; custom_agent_id?: string; name?: string } | undefined;
