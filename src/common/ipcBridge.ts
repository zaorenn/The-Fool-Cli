...
export const database = {
  ...
  searchConversationMessages: bridge.buildProvider<import('./types/database').IMessageSearchResponse, { keyword: string; page?: number; pageSize?: number }>('database.search-conversation-messages'),
};
