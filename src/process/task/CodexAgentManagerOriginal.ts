...
import { CodexAgentEventType, type CodexAgentEvent, type CodexAgentManagerData } from '@/common/codexTypes';
...
class CodexAgentManager extends BaseAgentManager<CodexAgentManagerData> {
  ...
  private initAgent(data: CodexAgentManagerData) {
    this.agent = new CodexMcpAgent({
      ...
      onEvent: (evt) => this.handleAgentEvent(evt as CodexAgentEvent),
  ...
  private handleAgentEvent(evt: CodexAgentEvent) {
    const type = evt.type;
