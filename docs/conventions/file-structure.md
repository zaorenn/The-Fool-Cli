...
- **README files**: keep `readme.md` (English) and `readme_ch.md` (Simplified Chinese) at root; place other translations in `docs/readme/`
...
| Action                                               | Files                                                       |
| ---------------------------------------------------- | ----------------------------------------------------------- |
| Move remaining readme translations to `docs/readme/` | `readme_{es,jp,ko,pt,tr,tw}.md`                             |
