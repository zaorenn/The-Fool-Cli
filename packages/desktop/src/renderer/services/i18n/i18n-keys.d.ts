...
export type I18nKey =
  ...
  | 'settings.agentManagement.disableConfirmCancel'
  | 'settings.agentManagement.disableConfirmConfirm'
  | 'settings.agentManagement.disableConfirmIntro'
  | 'settings.agentManagement.disableConfirmKeepWorking'
  | 'settings.agentManagement.disableConfirmReenableHint'
  | 'settings.agentManagement.disableConfirmScopeAssistant'
  | 'settings.agentManagement.disableConfirmScopeHome'
  | 'settings.agentManagement.disableConfirmScopeTeam'
  | 'settings.agentManagement.disableConfirmTitle'
  ...
  | 'settings.agentManagement.sectionDisabled'
  | 'settings.agentManagement.sectionEnabled'
