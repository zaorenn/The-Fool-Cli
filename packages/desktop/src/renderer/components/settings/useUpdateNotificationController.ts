...
export const UPDATE_AVAILABLE_EVENT = 'fool-update-available';
...
const RELEASES_PAGE_URL = 'https://github.com/zaorenn/The-Fool-Cli/releases';
...
export const useUpdateNotificationController = () => {
  ...
  useEffect(() => {
    ...
    window.addEventListener('fool-open-update-modal', handleWindowOpen);
    ...
    return () => {
      removeOpenListener();
      window.removeEventListener('fool-open-update-modal', handleWindowOpen);
