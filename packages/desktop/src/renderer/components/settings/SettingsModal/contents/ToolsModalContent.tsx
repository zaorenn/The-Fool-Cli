                ...
                {imageGenerationModelList.length > 0 ? (
                  ...
                  >
                    {imageGenerationModelList.map(({ models, ...platform }) => (
                      <FoolSelect.OptGroup label={platform.name} key={platform.id}>
                        {models.map((modelName) => (
                          <FoolSelect.Option key={platform.id + modelName} value={platform.id + '|' + modelName}>
                            {modelName}
                          </FoolSelect.Option>
                        ))}
                      </FoolSelect.OptGroup>
                    ...
                    <Tooltip
                      content={
                        <div>
                          ...
                          <a
                            href='https://github.com/zaorenn/The-Fool-Cli/tree/main/docs/guides'
                            target='_blank'
