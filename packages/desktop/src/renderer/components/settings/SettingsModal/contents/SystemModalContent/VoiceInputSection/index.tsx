        ...
        <>
          ...
          <Form layout='horizontal' labelAlign='left' className='space-y-12px'>
            <Form.Item label={t('settings.speechToTextSource')}>
              <FoolSelect value={source} onChange={handleSourceChange}>
                <FoolSelect.Option value='openai'>{t('settings.speechToTextSourceOpenAI')}</FoolSelect.Option>
                <FoolSelect.Option value='deepgram'>{t('settings.speechToTextSourceDeepgram')}</FoolSelect.Option>
                <FoolSelect.Option value='custom'>{t('settings.speechToTextSourceCustom')}</FoolSelect.Option>
              </FoolSelect>
            </Form.Item>
                  ...
                  const badgeText =
                    capability === 'supported'
                      ...
                      : capability === 'unsupported'
                        ...
                        : null;
                  return (
                    <FoolSelect.Option key={model} value={model}>
                      {model}
            ...
            <Form.Item label={t('settings.speechToTextLanguage')}>
              <FoolSelect value={activeLanguage} onChange={handleLanguageChange}>
                {SPEECH_LANGUAGE_OPTIONS.map((option) => (
                  <FoolSelect.Option key={option.value || 'auto'} value={option.value}>
