...
const FoolSearchInput = forwardRef<HTMLInputElement, FoolSearchInputProps>((props, ref) => {
  const {
    value,
    onChange,
    placeholder,
...
FoolSearchInput.displayName = 'FoolSearchInput';

export default FoolSearchInput;
