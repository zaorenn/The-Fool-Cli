 ...
 * <FoolScrollArea className="h-400px">
 *   <div>Content...</div>
 * </FoolScrollArea>
 *
 * // 水平滚动 / Horizontal scroll
 * <FoolScrollArea direction="x" className="w-400px">
 *   <div className="whitespace-nowrap">Content...</div>
 * </FoolScrollArea>
 *
 * // 双向滚动 / Both directions
 * <FoolScrollArea direction="both" className="h-400px w-400px">
 *   <div>Content...</div>
 * </FoolScrollArea>
 * ```
 */
interface FoolScrollAreaProps extends React.HTMLAttributes<HTMLDivElement> {
...
const FoolScrollArea: React.FC<FoolScrollAreaProps> = ({
  children,
  className,
  direction = 'y',
...
FoolScrollArea.displayName = 'FoolScrollArea';

export default FoolScrollArea;
