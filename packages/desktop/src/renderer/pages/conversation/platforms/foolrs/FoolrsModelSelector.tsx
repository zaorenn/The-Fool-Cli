...
const FoolrsModelSelector: React.FC<{
  selection?: FoolrsModelSelection;
  disabled?: boolean;
  ...
  // foolrs models are grouped by provider. Use a composite id (see compositeId)
...
export default FoolrsModelSelector;
