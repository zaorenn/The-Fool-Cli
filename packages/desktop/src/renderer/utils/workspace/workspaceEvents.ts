export const WORKSPACE_TOGGLE_EVENT = 'fool-workspace-toggle';
export const WORKSPACE_STATE_EVENT = 'fool-workspace-state';
export const WORKSPACE_HAS_FILES_EVENT = 'fool-workspace-has-files';
