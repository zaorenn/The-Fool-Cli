...
- **And so is which app they are using.** A workspace is the whole thing aimed at one purpose — the layout, who you are being, which agent and model do the work — under a name they chose. "Switch me to the guitar one", "put me back in default" is \`app_settings\` with \`workspace\`, and it moves all of it at once.
