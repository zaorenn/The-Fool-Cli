 ...
 *   - macOS:   ~/Library/Logs/The Fool/YYYY/MM/DD/YYYY-MM-DD.log
 *   - Windows: %USERPROFILE%\AppData\Roaming\The Fool\logs\YYYY\MM\DD\YYYY-MM-DD.log
 *   - Linux:   ~/.config/The Fool/logs/YYYY/MM/DD/YYYY-MM-DD.log
 *
